...
function AdminPage() {
  const [activeTab, setActiveTab] = useState<'overview' | 'properties' | 'agreements'>('overview')
    ...
    <ContentWrapper>
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex bg-slate-100 p-1 rounded-lg self-start">
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-md transition-all ${activeTab === 'properties' ? 'bg-white text-purple-600 shadow-sm' : 'text-slate-600 hover:text-slate-900'}`}
          >
            All Properties
          </button>
          <button
            onClick={() => setActiveTab('agreements')}
            className={`px-4 py-2 text-sm font-medium rounded-md transition-all ${activeTab === 'agreements' ? 'bg-white text-purple-600 shadow-sm' : 'text-slate-600 hover:text-slate-900'}`}
          >
            All Agreements
          </button>
        </div>
        ...
        <div className="flex gap-3">
          <Link
            ...
            className="px-4 py-2 bg-white text-slate-700 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors text-sm font-medium flex items-center gap-2"
          >
      ...
      {activeTab === 'overview' && (
        <>
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-sans font-bold text-slate-900 mb-6">Overview</h2>
      ...
      {/* AGREEMENTS TAB */}
      {activeTab === 'agreements' && <AdminAgreements />}
    </ContentWrapper>
  )
}
